    ...
    try {
      ...
      lines.forEach((line, index) => {
        ...
        if (matchType === "Singles") {
          ...
          team = {
            id: `team-${Date.now()}-${index}-${Math.random()
              .toString(36)
              .substring(2, 9)}`,
            name: parts[0],
          ...
          if (parts.length < 3) {
            throw new Error(
              `Line ${
                index + 1
              }: For doubles, need at least team name and 2 players`
            );
          }
        ...
        <TabsContent value="basic">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Edit the basic details of your tournament
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="teams">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Add or remove teams from the tournament
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  <h3 className="text-lg font-medium mb-4">
                    Team List ({tournament.teams.length})
                  </h3>
        ...
        <TabsContent value="bulk">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Add multiple teams at once by pasting data in CSV format
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-md">
                  ...
                  <p className="text-sm mb-2">
                    Enter one team per line in the following format:
                  </p>
                  {tournament.matchType === "Singles" ? (
                    <p className="text-sm font-mono bg-blue-100 dark:bg-blue-800 p-2 rounded">
                      Player Name, Skill Level (optional), Age Group (optional),
                      Gender (optional)
                    </p>
                  ) : (
                    <p className="text-sm font-mono bg-blue-100 dark:bg-blue-800 p-2 rounded">
                      Team Name, Player1 Name, Player2 Name, Skill Level
                      (optional), Age Group (optional), Gender (optional)
                    </p>
                  )}
...
Example: ${
                  ...
                  />
                  {bulkTeamsError && (
                    <p className="text-sm text-red-500">{bulkTeamsError}</p>
                  )}
                </div>

                <Button
                  onClick={handleBulkAddTeams}
                  disabled={!bulkTeamsText.trim()}
                >
